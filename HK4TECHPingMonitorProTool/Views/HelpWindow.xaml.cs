...
namespace HK4TECHPingMonitorProTool.Views
{
    ...
    public partial class HelpWindow : Window
    {
        ...
        public HelpWindow()
        {
            ...
            Version.Inlines.Add(new Run($"Version: 1.1.0"));

            // Generate copyright text based on the current year.
            //Copyright.Text = $"Copyright \u00a9 {DateTime.Now.Year.ToString()} Ahmed Nasser HK";
            Copyright.Inlines.Clear();
            Copyright.Inlines.Add(new Run($"Copyright \u00a9 {DateTime.Now.Year.ToString()} Ahmed Nasser HK"));

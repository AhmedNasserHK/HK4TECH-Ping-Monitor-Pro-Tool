...
namespace HK4TECHPingMonitorProTool.Classes
{
    class Configuration
    {
        public static string FilePath = Environment.ExpandEnvironmentVariables(@"%LOCALAPPDATA%\HK4TECH Ping Monitor Pro Tool\HK4TECHPingMonitorProTool.xml");
        ...
        static Configuration()
        {
            ...
            if (File.Exists(AppDomain.CurrentDomain.BaseDirectory + "HK4TECHPingMonitorProTool.xml"))
                FilePath = AppDomain.CurrentDomain.BaseDirectory + "HK4TECHPingMonitorProTool.xml";
        }
